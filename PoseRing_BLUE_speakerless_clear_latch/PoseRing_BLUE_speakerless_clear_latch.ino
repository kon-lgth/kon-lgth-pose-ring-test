...
// ============================================================
// PoseRing BLUE device firmware / speakerless
// - BLE接続中は白色に点灯
// - ゴール外では距離に応じて白→赤へ変化
// - ゴール判定内に入っている間はblue blink
...
const char* DEVICE_NAME = "PoseRing_BLUE";
...
void setup() {
  ...
  Serial.print("PoseRing BLUE speakerless BLE device ready: ");
